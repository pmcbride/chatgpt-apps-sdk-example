...
const USE_MOCK = process.env.USE_MOCK_API === "true" || !process.env.MCP_API_URL;
...
export class PostService {
    async getPosts(params) {
        if (USE_MOCK) {
            return mockPosts.slice(params.offset || 0, (params.offset || 0) + (params.limit || 10));
        }
        ...
        return data; // Assuming API validation happens on the other side, but we could parse with Zod here too
    }
