...
const TOOLS: Tool[] = [
  {
    name: "scrape_posts",
    description:
      "Scrape blog posts directly from pmmcbride.com website HTML (fallback method)",
    inputSchema: {
      type: "object",
      properties: {},
      required: [],
  ...
  },
  {
    ...
    inputSchema: zodToJsonSchema(GetPostsInputSchema as any) as any,
  },
  {
    name: "create_post",
    description: "Create a new blog or playbook post",
    inputSchema: zodToJsonSchema(CreatePostInputSchema as any) as any,
  },
  {
    name: "delete_post",
    description: "Delete (archive) a post by slug",
    inputSchema: zodToJsonSchema(DeletePostInputSchema as any) as any,
  },
];
